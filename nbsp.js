...
console.log ("grammar -> str small");
test (grammar, str_small);

var fstr = fs.readFileSync ('nbsp.txt');
console.log ("grammar -> str small from file");
test (grammar,fstr);


var fgrammar = fs.readFileSync ('nbsp.ohm');
var fstr = fs.readFileSync ('nbsp.txt');
console.log ("fgrammar -> str small");
test (fgrammar, str_small);
console.log ("fgrammar -> str small from file");
test (fgrammar, fstr);
